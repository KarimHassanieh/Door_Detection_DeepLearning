...
while True:
    ...
    if cv2.waitKey(1) & 0xFF == 27:
        ...
        resize = cv2.resize(frame,(256,256), interpolation = cv2.INTER_NEAREST)

        # Save the image
        cv2.imwrite('/home/karim/Desktop/Dataset/' + set_dir + '/' + name_type + "_" + str(number) + ".png", resize)
        print('/home/karim/Desktop/Dataset/' + set_dir + '/' + name_type + "_" + str(number) + ".png")
